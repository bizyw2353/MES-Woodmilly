...
public class EditProcAccountController implements Controller {
    private static final String METHOD = "POST";

    @Override
    public String getMethod() {
        return EditProcAccountController.METHOD;
    }
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (result) {
            ...
            System.out.println("EditProc ==========");
            return "/mes/script/redirect.jsp";
        }
        request.setAttribute("message", "거래처 변경이 실패하였습니다.");
        request.setAttribute("target", "/accountEdit.do=id" + dto.getId());
        return "/mes/script/redirect.jsp";
    }
}
